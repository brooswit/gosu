...
class TestImageIO < Minitest::Test
  ...
  def test_load_tiles
    ...
    win = ScreenshotWindow.draw(250, 100) do
      retro_tiles[0].draw(-80, 0, 0, scale_x: 4.0, scale_y: 4.0)
      tiles[0].draw(50, 0, 0, scale_x: 4.0, scale_y: 4.0, mode: :add)

      retro_tiles[1].draw(0, 0, 0, scale_x: 0.5, scale_y: 0.5)
  ...
  def test_draw_with_angle
    win = ScreenshotWindow.draw(100, 100) do
      ...
      @image.draw(50, 50, 0, center_x: -1.0, center_y: -1.0, scale_x: 0.5, scale_y: 0.5, color: 0xff_ffffff, mode: :default)
    end
    assert_screenshot_matches win, 'rotation.png'
  end
  ...
  def test_blend_modes
    win = ScreenshotWindow.draw(100,100) do
      ...
      image.draw(0, 0, 0)
      image.draw(0, 0, 0, mode: :default, angle: 180, center_x: 1.0, center_y: 1.0)

      image.draw(50, 0, 0)
      image.draw(50, 0, 0, mode: :add, angle: 180, center_x: 1.0, center_y: 1.0)

      image.draw(0, 50, 0)
      image.draw(0, 50, 0, mode: :multiply, angle: 180, center_x: 1.0, center_y: 1.0)

      image.draw(50, 50, 0)
      image.draw(50, 50, 0, mode: :replace, angle: 180, center_x: 1.0, center_y: 1.0)
    end
